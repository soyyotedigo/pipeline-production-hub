...
@router.get("/{id}", response_model=TimeLogResponse)
...
@router.patch("/{id}", response_model=TimeLogResponse)
...
# Project timelogs
@projects_router.get("/{id}/timelogs", response_model=list[TimeLogResponse])
...
@projects_router.get("/{id}/timelogs/summary", response_model=ProjectTimeLogSummary)
...
@tasks_router.get("/{id}/timelogs", response_model=list[TimeLogResponse])
...
# User timelogs
@users_router.get("/{id}/timelogs", response_model=list[TimeLogResponse])
