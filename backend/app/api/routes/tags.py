...
@projects_router.get("/{id}/tags", response_model=list[TagResponse])
...
@projects_router.post("/{id}/tags", response_model=TagResponse, status_code=201)
...
# Shot tag endpoints
@shots_router.post("/{id}/tags", response_model=EntityTagResponse, status_code=201)
...
@shots_router.get("/{id}/tags", response_model=list[TagResponse])
...
# Asset tag endpoints
@assets_router.post("/{id}/tags", response_model=EntityTagResponse, status_code=201)
...
@assets_router.get("/{id}/tags", response_model=list[TagResponse])
...
@sequences_router.post("/{id}/tags", response_model=EntityTagResponse, status_code=201)
...
@sequences_router.get("/{id}/tags", response_model=list[TagResponse])
...
@entity_tags_router.delete("/{id}", status_code=204)
